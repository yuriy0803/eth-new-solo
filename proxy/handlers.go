...
var workerPattern = regexp.MustCompile("^[0-9a-zA-Z-_]{1,250}$")
...
func (s *ProxyServer) handleGetWorkRPC(cs *Session) ([]string, *ErrorReply) {
	...
	return []string{t.Header, t.Seed, s.diff, util.ToHex(int64(t.Height)), "Height", util.ToHex1(int64(t.Height)), "algo: ethash"}, nil
}
